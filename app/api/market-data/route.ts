...
export async function GET() {
  ...
  const [stocks, crypto, indices, sentiment, cnnFearGreed, btcMetrics] = await Promise.all([
    ...
    fetchIndices().catch((err) => {
      ...
      return { sp500: null, vix: null, gold: null, crudeOil: null, dxy: null };
    }),
    ...
    fetchBTCMetrics().catch((err) => {
      ...
      return { ahr999: null, weeklyRsi: null, volume24h: null, volumeChangePercent: null, sthSopr: null, lthSopr: null, lthSupplyPercent: null, wma200Price: null, wma200Multiplier: null, nupl: null, lthMvrv: null, ma365Price: null, ma365Ratio: null, etfFlowUsd: null, etfFlowDays: [] as number[], fundingRate: null, longShortRatio: null };
    }),
  ]);
  ...
  const responseData: MarketDataResponse = {
    ...
    crypto,
    indices: {
      sp500: indices.sp500 ?? { price: 0, changePercent: 0 },
