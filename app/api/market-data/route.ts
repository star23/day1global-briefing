...
export async function GET() {
  ...
  const [stocks, crypto, indices, sentiment, cnnFearGreed, btcMetrics] = await Promise.all([
    ...
    fetchBTCMetrics().catch((err) => {
      ...
      return { weeklyRsi: null, volume24h: null, volumeChangePercent: null, sthSopr: null, lthSopr: null, lthSupplyPercent: null, wma200Price: null, wma200Multiplier: null, nupl: null, lthMvrv: null, ma365Price: null, ma365Ratio: null };
    }),
  ]);
